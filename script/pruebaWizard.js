...
jQuery(document).ready(function () {
  ...
  jQuery(".form-wizard-next-btn").click(function () {
    ...
    parentFieldset.find(".wizard-required").each(function () {
      ...
      if (thisValue == "") {
       ...
       // jQuery(this).find(".wizard-email-error").slideDown();
        console.log("valores");
        nextWizardStep = false;
      }
        if(!regex.test(email)){
          jQuery(this).siblings(".wizard-email-error").slideDown();
          console.log("mail");
          nextWizardStep = false;
        }
       else {
        jQuery(this).siblings(".wizard-form-error").slideUp();
        jQuery(this).siblings(".wizard-email-error").slideUp();
      }
  ...
  $(".resumen").on("click", function () {
    ...
    document.getElementById("listarApellido").innerHTML =
      "Apellido: " + apellido;
    ...
    document.getElementById("listarDomicilio").innerHTML =
      "Domicilio: " + domicilio;
    document.getElementById("listarProducto").innerHTML =
      "Producto: " + valorSeleccionado1;
    document.getElementById("listarActividad").innerHTML =
      "Actividad: " + valorSeleccionado2;
    document.getElementById("listarNegocio").innerHTML =
